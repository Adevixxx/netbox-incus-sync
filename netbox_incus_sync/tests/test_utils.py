...
from netbox_incus_sync.services.sync_utils import (
    parse_memory, parse_size, sanitize_config, sanitize_devices,
    extract_limits, extract_security, get_instance_type_tag,
)
...
class ExtractSecurityTests(SimpleTestCase):
    ...
    def test_booleans(self):
        r = extract_security({'security.nesting': 'true', 'security.privileged': 'false'})
